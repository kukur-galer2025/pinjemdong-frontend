              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", marginBottom: "16px" }}>
                <div>
                  ...
                  <div style={{
                    ...
                    {v.ktp_image ? (
                      <img src={`${process.env.NEXT_PUBLIC_API_BASE_URL || "http://localhost:8000"}/storage/${v.ktp_image}`} alt="KTP"
                ...
                <div>
                  ...
                  <div style={{
                    ...
                    {v.selfie_image ? (
                      <img src={`${process.env.NEXT_PUBLIC_API_BASE_URL || "http://localhost:8000"}/storage/${v.selfie_image}`} alt="Selfie"
                        style={{ width: "100%", height: "100%", objectFit: "cover", cursor: "pointer" }}
                        onClick={() => setDetail(v)}
                      />
                    ) : <span style={{ color: "var(--foreground-muted)" }}>—</span>}
          ...
          <div className="card" style={{
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "24px" }}>
              <div>
                ...
                {detail.ktp_image && (
                  <img src={`${process.env.NEXT_PUBLIC_API_BASE_URL || "http://localhost:8000"}/storage/${detail.ktp_image}`} alt="KTP"
              ...
              <div>
                ...
                {detail.selfie_image && (
                  <img src={`${process.env.NEXT_PUBLIC_API_BASE_URL || "http://localhost:8000"}/storage/${detail.selfie_image}`} alt="Selfie"
                    style={{ width: "100%", borderRadius: "var(--radius-md)", border: "1px solid var(--border)" }} />
                )}
              </div>
            </div>
